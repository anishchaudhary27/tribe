import { Button, IconButton, Text, Tooltip } from "@chakra-ui/react";
import { Link, useNavigate } from "react-router-dom";
import { FiGithub, FiLogIn, FiSearch } from "react-icons/all";
    ...
    <div className="flex justify-center">
      ...
      <div className="mt-20 p-2 max-w-md flex items-center flex-col">
        <Text textAlign="center">
          On Tribe, you can let your fans become active participants in the work
          they love by offering them a monthly membership. You give them access
          to exclusive content, community, and insight into your creative
